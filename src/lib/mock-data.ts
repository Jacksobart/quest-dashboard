...
export const agents: AgentConfig[] = [
  { name: 'backend', description: 'Backend API and services', files_own: ['src/api/**', 'src/services/**'], files_read: ['src/shared/**'], color: '#6366f1', icon: '⚡', missionsAssigned: 5, missionsCompleted: 1 },
