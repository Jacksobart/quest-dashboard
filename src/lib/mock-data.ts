...
export const agents: AgentConfig[] = [
  { name: 'backend', description: 'Backend API and services', files_own: ['src/api/**', 'src/services/**'], files_read: ['src/shared/**'], color: '#00aaff', icon: '⚡', missionsAssigned: 5, missionsCompleted: 1 },
