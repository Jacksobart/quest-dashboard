...
export const agents: AgentConfig[] = [
  { name: 'backend', description: 'Backend API and services', files_own: ['src/api/**', 'src/services/**'], files_read: ['src/shared/**'], color: '#ff5252', icon: '⚡', missionsAssigned: 5, missionsCompleted: 1 },
